  ...
  if (error || !order) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-red-500">
        ...
        <Link to="/admin/orders" className="mt-6 text-green-600 hover:underline font-semibold flex items-center">
    ...
    <div className="min-h-screen bg-gray-100 p-6 md:p-10">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8 space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/admin/orders" className="text-green-600 hover:underline flex items-center font-semibold">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            <h2 className="font-bold text-green-700 mb-2">Customer Info</h2>
            <div className="mb-2">
              <span className="font-semibold">Name:</span> {userId?.name || "N/A"}
            </div>
            <div className="mb-2">
              <span className="font-semibold">Email:</span> {userId?.email || "N/A"}
            </div>

            <h2 className="font-bold text-green-700 mt-4 mb-2">Shipping Address</h2>
            <div className="mb-1">{shippingAddress?.street}</div>
            <div className="mb-1">{shippingAddress?.city}, {shippingAddress?.state} {shippingAddress?.zip}</div>
